  ...
  return (
    ...
    >
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {/* === Navigasi ke Halaman Aduan === */}
        <View style={styles.section}>
          <TouchableOpacity
            style={[styles.navItem, { backgroundColor: theme.surface }]}
            onPress={() => router.push("/BuyerComplaint")}
          >
...
const styles = StyleSheet.create({
  ...
  navText: { fontSize: 16, marginLeft: 12, fontWeight: "500" },
  settingItem: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
