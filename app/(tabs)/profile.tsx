  ...
  return (
    ...
    >
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {/* Tombol Edit Profile → Navigasi ke /editprofile */}
            ...
            <View style={styles.languageButtons}>
              <TouchableOpacity
                style={[
                  ...
                  {
                    backgroundColor:
                      i18n.language === "id" ? theme.primary : theme.background,
                  },
                ]}
              ...
              >
                <Text
                  style={[
                    styles.langText,
                    { color: i18n.language === "id" ? "#FFFFFF" : theme.text },
                  ]}
                >
                  ID
                </Text>
              ...
              <TouchableOpacity
                style={[
                  ...
                  {
                    backgroundColor:
                      i18n.language === "en" ? theme.primary : theme.background,
                  },
                ]}
              ...
              >
                <Text
                  style={[
                    styles.langText,
                    { color: i18n.language === "en" ? "#FFFFFF" : theme.text },
                  ]}
                >
                  EN
                </Text>
            ...
            <View style={styles.themeButtons}>
              <TouchableOpacity
                style={[
                  ...
                  {
                    backgroundColor:
                      themeMode === "light" ? theme.primary : theme.background,
                  },
                ]}
              ...
              <TouchableOpacity
                style={[
                  ...
                  {
                    backgroundColor:
                      themeMode === "dark" ? theme.primary : theme.background,
                  },
                ]}
        ...
        <View style={styles.logoutContainer}>
          <Button title={t("auth.logout")} onPress={handleLogout} variant="outline" />
        </View>
      </ScrollView>
    </SafeAreaView>
  );
